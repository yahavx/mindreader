...
class Context:
    ...
    default_base_dir = Path(__file__).parent.parent.parent.parent / 'mindreader_internal_data'  # project root
    """This is the default directory which files are saved into, when creating a context object"""
